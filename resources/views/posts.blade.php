...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3 text-center">
            ...
            @else
                <img src="https://source.unsplash.com/500x300?{{ $posts[0]->category->name }}" class="card-img-top"
                    alt="{{ $posts[0]->category->name }}" class="img-fluid">
            @endif

            <div class="card-body">
                <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none btn ">
