 <!-- Navbar -->
 <nav class="main-header navbar navbar-expand navbar-white navbar-light navbar navbar-expand-lg  navbarBGcolor fixed-top"
     ...
     <ul class="navbar-nav ml-auto">
         ...
         <form action="/logout" method="post">
             @csrf
             <button type="submit" class="nav-link px-3 bg-transparent border-0"> logout <span data-feather="log-out">
                 </span></button>
         </form>
         {{-- pengaturan --}}
         {{-- <li class="nav-item">
